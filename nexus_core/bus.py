...
class EventBus:
    ...
    def publish(self, event_type: str, event_data: Any) -> None:
        ...
        logger.info(f"Disparando evento '{event_type}' para {len(self._listeners[event_type])} suscriptores.")
        ...
        for callback in self._listeners[event_type]:
            try:
                ...
                logger.error(f"Error procesando el evento '{event_type}' en el suscriptor {callback.__name__}: {e}")
